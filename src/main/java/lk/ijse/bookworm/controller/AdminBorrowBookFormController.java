...
public class AdminBorrowBookFormController {
    ...
    private final BookTransactionBO bookTransactionBO = (BookTransactionBO) BOFactory.getInstance().getBO(BOFactory.BOTypes.BOOK_TRANSACTION);
    ...
    private void setCellValueFactory() {
        ...
        colRemove.setCellFactory(new Callback<>() {
            @Override
...

                    {
                        ...
                        btn.setOnAction(event -> {
                            ...
                            if (isDeleted) {
                                ...
                                new Alert(Alert.AlertType.ERROR, "User Doesn't Deleted").show();
                            }
    ...
    private void loadUserIds() {
        ...
        userBO.getAllUsers().forEach(dto -> cmbUserID.getItems().add(dto.getEmail()));
    }
    ...
    private boolean validateFields() {
        ...
        if (dpReturnDate.getText().isEmpty()) {
